...
public class BoardController implements BoardApiDocs {
    ...
    @PostMapping public ResponseEntity<Long> createBoard(@RequestBody @Valid BoardCreateRequest request,
            @com.gjaku1031.templateforagent.presentation.common.annotation.CurrentUser Long userId){return ResponseEntity.ok(boardService.create(userId, request.getTitle(), request.getContent()));}
